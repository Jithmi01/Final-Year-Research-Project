      ...
      body: Stack(
        children: [
          ...
          if (_detectionResult != null && 
              _detectionResult!['face_box'] != null && 
              _showCapturedImage)
            Positioned.fill(
              child: CustomPaint(
                painter: FaceBoxPainter(
                  _detectionResult!['face_box'],
                  true, // is captured image
                ),
              ),
            ),
...
class FaceBoxPainter extends CustomPainter {
  ...
  FaceBoxPainter(this.box, this.isCapturedImage);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final rect = Rect.fromLTWH(x1, y1, boxWidth, boxHeight);
    ...
    // Corner brackets
    final bracketLength = (boxWidth * 0.15).clamp(20.0, 40.0);
    ...
    canvas.drawLine(
      Offset(x1, y1),
      Offset(x1 + bracketLength, y1),
      bracketPaint,
    );
    canvas.drawLine(
      Offset(x1, y1),
      Offset(x1, y1 + bracketLength),
      bracketPaint,
    );
    ...
    canvas.drawLine(
      Offset(x2, y1),
      Offset(x2 - bracketLength, y1),
      bracketPaint,
    );
    canvas.drawLine(
      Offset(x2, y1),
      Offset(x2, y1 + bracketLength),
      bracketPaint,
    );
    ...
    canvas.drawLine(
      Offset(x1, y2),
      Offset(x1 + bracketLength, y2),
      bracketPaint,
    );
    canvas.drawLine(
      Offset(x1, y2),
      Offset(x1, y2 - bracketLength),
      bracketPaint,
    );
    ...
    canvas.drawLine(
      Offset(x2, y2),
      Offset(x2 - bracketLength, y2),
      bracketPaint,
    );
    canvas.drawLine(
      Offset(x2, y2),
      Offset(x2, y2 - bracketLength),
      bracketPaint,
    );
